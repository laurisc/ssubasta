	function agregarCiudad(fila) {		
		...
		selectInicial = document.getElementById("ciudad"+fila);		
		...
		dondePegar.rows[fila].cells[5].appendChild(selectTemp);
		...
		dondePegar.rows[fila].cells[5].appendChild(vacio);
		
		dondePegar.rows[fila].cells[7].appendChild(campoTemp1);
		dondePegar.rows[fila].cells[8].appendChild(campoTemp2);
		dondePegar.rows[fila].cells[9].appendChild(campoTemp3);
		dondePegar.rows[fila].cells[10].appendChild(campoTemp4);
		dondePegar.rows[fila].cells[11].appendChild(campoTemp5);
		dondePegar.rows[fila].cells[12].appendChild(campoTemp6);
		...
		dondePegar.rows[fila].cells[7].appendChild(elastTemp1);
		dondePegar.rows[fila].cells[8].appendChild(elastTemp2);
		dondePegar.rows[fila].cells[9].appendChild(elastTemp3);
		dondePegar.rows[fila].cells[10].appendChild(elastTemp4);
		dondePegar.rows[fila].cells[11].appendChild(elastTemp5);
		dondePegar.rows[fila].cells[12].appendChild(elastTemp6);
	}
	
	function eliminarCiudad(fila) {
		...
		if(cantidadFilas>1)
		{
			...
			var selectAEliminar = document.getElementById("ciudad" + fila + cantidadFilas);
			...
			//Elimina los campos
			dondeEliminar.rows[fila].cells[5].removeChild(selectAEliminar);
			dondeEliminar.rows[fila].cells[5].removeChild(span);
			dondeEliminar.rows[fila].cells[7].removeChild(campoActual1);
			dondeEliminar.rows[fila].cells[8].removeChild(campoActual2);
			dondeEliminar.rows[fila].cells[9].removeChild(campoActual3);
			dondeEliminar.rows[fila].cells[10].removeChild(campoActual4);
			dondeEliminar.rows[fila].cells[11].removeChild(campoActual5);
			dondeEliminar.rows[fila].cells[12].removeChild(campoActual6);
			dondeEliminar.rows[fila].cells[7].removeChild(elastActual1);
			dondeEliminar.rows[fila].cells[8].removeChild(elastActual2);
			dondeEliminar.rows[fila].cells[9].removeChild(elastActual3);
			dondeEliminar.rows[fila].cells[10].removeChild(elastActual4);
			dondeEliminar.rows[fila].cells[11].removeChild(elastActual5);
			dondeEliminar.rows[fila].cells[12].removeChild(elastActual6);
