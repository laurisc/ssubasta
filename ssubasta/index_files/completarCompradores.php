<?php
	...
	while ($row = mysql_fetch_object ($res)) {
		...
		$tmpComprador .= '<td><a href="javascript:void(0);" onclick="agregarCiudad(' . $contador . ')" rel="tooltip" class="icon-plus" data-original-title="Agregar otra ciudad."></a>
		<a href="javascript:void(0);" onclick="eliminarCiudad(' . $contador . ')" rel="tooltip" class="icon-remove" data-original-title="Eliminar un campo."></a></td>';			
		$tmpComprador .= ' </td>';
