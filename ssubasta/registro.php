<?php
	...
	$unSesion->redirecInicioSesionRegistro ('index.php') ;
...
//		if ($_POST['clave'] == $_POST['reclave']) {
			$_POST['razonSocial'] = (isset ($_POST['razonSocial'])) ? $_POST['razonSocial'] : '' ;
			$_POST['representanteLegal'] = (isset ($_POST['representanteLegal'])) ? $_POST['representanteLegal'] : '' ;
			
			$unUsuario = new usuario ($_POST['tipoDocumento'], $_POST['documento'], $_POST['razonSocial'], $_POST['representanteLegal'], $_POST['actividadEconomica'], $_POST['direccion'], $_POST['ciudad'], $_POST['telefonoUno'], $_POST['telefonoDos']);
			if ($unUsuario->validarUsuario()) {
				$sql = "INSERT INTO `usuario` (id, `tipo_documento` ,`documento` ,`razon_social` ,`representante` ,`actividad_economica` ,`direccion` ,`id_ciudad` ,`telefono_uno` ,`telefono_dos` ) 
				VALUES (" . $unSesion->obtenerVariable ('id') . ", '" . $_POST['tipoDocumento'] . "', '" . $_POST['documento'] . "', '" . $_POST['razonSocial'] . "', '" . $_POST['representanteLegal'] . "', '" . $_POST['actividadEconomica'] . "', '" . $_POST['direccion'] . "', '" . $_POST['ciudad'] . "', '" . $_POST['telefonoUno'] . "', '" . $_POST['telefonoDos'] . "');";
	//			echo $sql;
				$res = $conDB->SQL($sql);
				if (mysql_affected_rows () == 1 ) {
					unset($_POST);
					$nuevoRegistro = true;
					$unSesion->registrarVariable ('datosActualizados', true) ; 
...
//	echo $selectCiudad;
	...
	if (!$nuevoRegistro)
		include BASETPL . 'frm_registro.php';
	else
		include BASETPL . 'registro_exito.php';
